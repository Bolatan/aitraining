...
export default function Navbar() {
  ...
  return (
    <header className="bg-white/95 border-b border-slate-200 text-slate-900 sticky top-0 z-50 backdrop-blur-md shadow-xs">
            ...
            {loading ? (
              ...
              <div className="flex items-center space-x-3">
                ...
                <button
                  ...
                  className="px-3 py-1.5 text-xs font-medium text-slate-700 hover:text-slate-900 bg-slate-100 hover:bg-slate-200 rounded-md border border-slate-200 transition-colors flex items-center space-x-1"
                >
              ...
              <div className="flex items-center space-x-2">
                ...
                <Link
                  href="/signup"
                  className="px-4 py-1.5 text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 rounded-md shadow-xs transition-colors"
                >
                  Start Learning
                </Link>
              </div>
