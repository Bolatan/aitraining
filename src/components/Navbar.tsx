          ...
          <nav className="hidden md:flex items-center space-x-6">
            <Link
              ...
              className={`text-sm font-medium transition-colors ${
                pathname === '/' ? 'text-indigo-600 font-semibold' : 'text-slate-600 hover:text-indigo-600'
              }`}
            >
              Curriculum
            </Link>
              ...
              <>
                <Link
                  ...
                  className={`text-sm font-medium flex items-center space-x-1.5 transition-colors ${
                    pathname.startsWith('/dashboard') ? 'text-indigo-600 font-semibold' : 'text-slate-600 hover:text-indigo-600'
                  }`}
                >
                ...
                <Link
                  href="/capstone"
                  className={`text-sm font-medium flex items-center space-x-1.5 transition-colors ${
                    pathname.startsWith('/capstone') ? 'text-indigo-600 font-semibold' : 'text-slate-600 hover:text-indigo-600'
                  }`}
                >
          ...
          <div className="flex items-center space-x-3">
            {loading ? (
              ...
              <div className="flex items-center space-x-2">
                ...
                <Link
                  href="/signup"
                  className="px-4 py-1.5 text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 rounded-md shadow-sm transition-colors"
                >
                  Start Learning
                </Link>
              </div>
