          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200 pb-6">
            ...
            {isSubmitted && (
              <div className="shrink-0">
                <div className="px-4 py-2 rounded-xl bg-emerald-100 border border-emerald-300 text-emerald-800 text-xs font-bold flex items-center space-x-2 shadow-xs">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full px-3.5 py-2.5 bg-white border border-slate-300 rounded-lg text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent placeholder-slate-400"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full px-3.5 py-2.5 bg-white border border-slate-300 rounded-lg text-sm text-slate-900 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent placeholder-slate-400 font-mono"
              />
            </div>
            ...
            <div className="pt-4 border-t border-slate-200 flex items-center justify-between">
              <Link
                href="/dashboard"
                className="text-xs text-slate-600 hover:text-slate-900 transition-colors font-medium"
              >
              ...
              <button
                type="submit"
                disabled={submitting}
                className="px-6 py-3 rounded-xl bg-amber-500 hover:bg-amber-400 text-slate-950 font-bold text-xs shadow-md transition-all flex items-center space-x-2 disabled:opacity-50"
              >
                {submitting ? (
            ...
            <div className="pt-6 border-t border-slate-200 space-y-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="p-3 rounded-lg bg-slate-50 border border-slate-200 hover:border-slate-300 text-blue-700 flex items-center justify-between font-medium"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="p-3 rounded-lg bg-slate-50 border border-slate-200 hover:border-slate-300 text-purple-700 flex items-center justify-between font-medium"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="p-3 rounded-lg bg-slate-50 border border-slate-200 hover:border-slate-300 text-amber-700 flex items-center justify-between font-medium"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="p-3 rounded-lg bg-slate-50 border border-slate-200 hover:border-slate-300 text-emerald-700 font-mono flex items-center justify-between font-medium"
                >
