  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 flex flex-col font-sans">
      ...
      <div className="flex-1 max-w-4xl mx-auto w-full px-4 sm:px-6 py-12">
        <div className="space-y-8 bg-white p-8 rounded-2xl border border-slate-200 shadow-sm relative overflow-hidden">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200 pb-6">
            ...
            {isSubmitted && (
              <div className="shrink-0">
                <div className="px-4 py-2 rounded-xl bg-emerald-100 border border-emerald-300 text-emerald-800 text-xs font-bold flex items-center space-x-2 shadow-sm">
            ...
            <div className="pt-6 border-t border-slate-200 space-y-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="p-3 rounded-lg bg-slate-50 border border-slate-200 hover:border-slate-300 text-emerald-700 font-mono flex items-center justify-between"
                >
