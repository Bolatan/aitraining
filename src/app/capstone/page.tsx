      ...
      <div className="flex-1 max-w-4xl mx-auto w-full px-4 sm:px-6 py-12">
        <div className="space-y-8 bg-white p-8 rounded-2xl border border-slate-200 shadow-xl relative overflow-hidden">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200 pb-6">
            <div>
              <div className="inline-flex items-center space-x-1.5 text-xs font-bold uppercase tracking-wider text-amber-800 bg-amber-50 px-3 py-1 rounded-full border border-amber-300 mb-3">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-300 rounded-lg text-sm text-slate-900 focus:bg-white focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent placeholder-slate-400"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-300 rounded-lg text-sm text-slate-900 focus:bg-white focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent placeholder-slate-400 font-mono"
              />
            </div>
            ...
            <div className="pt-6 border-t border-slate-200 space-y-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="p-3 rounded-lg bg-slate-50 border border-slate-200 hover:bg-slate-100 text-blue-700 flex items-center justify-between"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="p-3 rounded-lg bg-slate-50 border border-slate-200 hover:bg-slate-100 text-purple-700 flex items-center justify-between"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="p-3 rounded-lg bg-slate-50 border border-slate-200 hover:bg-slate-100 text-amber-800 flex items-center justify-between"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="p-3 rounded-lg bg-slate-50 border border-slate-200 hover:bg-slate-100 text-emerald-700 font-mono flex items-center justify-between"
                >
