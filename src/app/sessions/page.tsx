...
export default function SessionsPage() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      ...
      case 'cancelled':
        return (
          <span className="px-2 py-0.5 rounded-full bg-rose-100 text-rose-800 border border-rose-200 text-[10px] font-bold flex items-center space-x-1">
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 flex flex-col font-sans">
      ...
      <div className="flex-1 max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-8 space-y-6">
          ...
          <div className="flex items-center space-x-3 w-full sm:w-auto justify-end">
            {currentUser?.isAdmin && (
              <button
                ...
                className="px-4 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-semibold shadow-xs flex items-center space-x-1.5 transition-colors"
              >
            ...
            <button
              ...
              className="p-2 rounded-xl bg-white hover:bg-slate-100 text-slate-700 text-xs font-semibold border border-slate-300 transition-colors"
              title="Refresh Data"
            >
          ...
          <div className="space-y-6">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 bg-white p-4 rounded-xl border border-slate-200 shadow-xs">
              ...
              <div className="flex items-center space-x-2">
                ...
                <select
                  ...
                  className="px-3 py-1.5 bg-white border border-slate-300 rounded-lg text-xs text-slate-900 focus:outline-none focus:ring-1 focus:ring-indigo-500"
                >
            ...
            {calendarViewMode === 'grid' ? (
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 bg-white p-6 rounded-2xl border border-slate-200 space-y-4 shadow-sm">
                  <div className="flex items-center justify-between border-b border-slate-200 pb-4">
                    ...
                    <div className="flex items-center space-x-2">
                      <button
                        onClick={handleToday}
                        className="px-2.5 py-1 text-xs bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-md border border-slate-300 transition-colors font-medium"
                      >
                        Today
                      </button>
                      <button
                  ...
                  <div className="grid grid-cols-7 gap-1">
                    ...
                    {Array.from({ length: firstDayOfMonth }).map((_, idx) => (
                      <div
                        key={`prev-${idx}`}
                        className="min-h-16 p-1.5 bg-slate-50 rounded-lg text-slate-400 text-xs font-mono select-none"
                      >
                      ...
                      return (
                        <div
                          ...
                          className={`min-h-20 p-1.5 rounded-lg border text-xs cursor-pointer transition-all flex flex-col justify-between ${
                            isSelected
                              ? 'bg-indigo-50 border-indigo-600 shadow-xs ring-1 ring-indigo-600/30'
                              : isToday
                ...
                {/* Day details panel */}
                <div className="bg-white p-6 rounded-2xl border border-slate-200 space-y-4 shadow-sm flex flex-col">
                      ...
                      selectedDateSessions.map((s) => (
                        ...
                        >
                          ...
                          <div className="pt-2 flex items-center justify-between border-t border-slate-200">
                            <Link
                              href={`/sessions/${s._id}`}
                              className="px-3 py-1.5 rounded-lg bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-bold flex items-center space-x-1.5 transition-colors shadow-xs"
                            >
                    ...
                    filteredSessions.map((s) => (
                      ...
                      >
                        ...
                        <div className="flex items-center space-x-3 shrink-0 w-full md:w-auto justify-end">
                          ...
                          <Link
                            href={`/sessions/${s._id}`}
                            className="px-4 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-bold flex items-center space-x-1.5 shadow-xs transition-colors"
                          >
        ...
        {activeTab === 'messages' && (
          <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden grid grid-cols-1 md:grid-cols-3 min-h-[550px] shadow-sm">
            {/* Contacts Sidebar */}
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center space-x-2.5 min-w-0">
                          <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-indigo-600 to-purple-600 flex items-center justify-center font-bold text-white text-xs shrink-0 shadow-xs">
                      ...
                      <div>
                        <h3 className="font-semibold text-slate-900 text-xs flex items-center space-x-1.5">
                          ...
                          {selectedContact.isAdmin && (
                            <span className="text-[10px] text-amber-800 bg-amber-100 px-1.5 py-0.2 rounded border border-amber-300 font-bold">
                              Admin Instructor
                            </span>
                          )}
                        </h3>
              ...
              <form onSubmit={handleScheduleSubmit} className="space-y-4">
                <div className="space-y-1.5">
                  ...
                  <select
                    ...
                    required
                    className="w-full px-3 py-2 bg-white border border-slate-300 rounded-xl text-xs text-slate-900 focus:outline-none focus:ring-1 focus:ring-indigo-500"
                  >
                ...
                <div className="pt-3 flex items-center justify-end space-x-3">
                  ...
                  <button
                    type="submit"
                    disabled={scheduling}
                    className="px-5 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-bold transition-colors shadow-xs disabled:opacity-50"
                  >
