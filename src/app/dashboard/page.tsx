      ...
      <div className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 flex flex-col md:flex-row gap-8">
        <aside className="w-full md:w-80 shrink-0 space-y-2">
          ...
          <div className="pt-4 border-t border-slate-200">
            <Link
              href="/capstone"
              className="w-full p-3.5 rounded-xl bg-gradient-to-r from-amber-50 to-purple-50 border border-amber-200 hover:border-amber-300 text-amber-900 flex items-center justify-between transition-colors block text-xs font-semibold shadow-sm"
            >
        ...
        <main className="flex-1 bg-white rounded-2xl border border-slate-200 p-6 sm:p-8 flex flex-col justify-between shadow-sm">
          {!user?.isAuthorized && !user?.isAdmin ? (
            <div className="my-auto py-12 text-center space-y-6 max-w-lg mx-auto">
              <div className="w-16 h-16 rounded-full bg-amber-100 border border-amber-300 flex items-center justify-center mx-auto text-amber-700 shadow-sm">
                <Key className="w-8 h-8" />
              </div>

              <div>
                <span className="text-xs font-mono uppercase tracking-widest text-amber-800 bg-amber-100 px-3 py-1 rounded-full border border-amber-200 font-semibold">
            ...
            <div className="space-y-8">
              <div
                ...
                style={{
                  ...
                  borderColor: `${selectedModule.accentColor}40`,
                }}
              >
                <div>
                ...
                <div className="p-6 rounded-2xl bg-slate-50 border border-slate-200 space-y-6">
                            ...
                            return (
                              <button
                                ...
                                className={`w-full text-left p-3 rounded-lg border text-xs transition-all flex items-center justify-between ${
                                  isSelected
                                    ? 'bg-indigo-50 border-indigo-500 text-slate-900 font-semibold'
                  ...
                  <div className="pt-2 flex items-center justify-between">
                    <button
                      ...
                      className="px-5 py-2.5 rounded-lg bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-semibold shadow-md transition-colors disabled:opacity-50"
                    >
