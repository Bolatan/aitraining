    ...
    lessons: [
      {
        ...
        body: '• Windows 11 — Best for: The desktop, windows, and files everything else in this course runs inside | Cost: ₦0 (Free — included with your PC)\n• Word — Best for: Polished, structured text documents and proposals | Cost: ₦0 (Free web version), or with an Office licence\n• PowerPoint — Best for: Visual, spoken narratives — slide decks and pitches | Cost: ₦0 (Free web version), or with an Office licence\n• Excel — Best for: Numbers, budgets in Nigerian Naira (₦), and simple charts | Cost: ₦0 (Free web version), or with an Office licence\n• Claude — Best for: Drafting and thinking partner for outlines, proposals, and copy | Cost: ₦0 (Free plan), no card required\n• ChatGPT — Best for: Generating and iterating infographic images | Cost: ₦0 (Free tier), with account-based usage limits\n• Bolt.new — Best for: Rapid, full-stack application prototyping — vibe coding | Cost: ₦0 (Free tier), daily token allowance\n• Cybersecurity Principles — Best for: Governance, risk management, framework applications, and practical security operations | Cost: ₦0 (Free course module)\n• MongoDB (Atlas) — Best for: Optional database for an application that needs to store data | Cost: ₦0 (Free Atlas tier available)\n• GitHub — Best for: Version control and the handoff point between every Module 5 tool | Cost: ₦0 (Free) for personal public and private repos\n• Vercel (Hobby) — Best for: Free hosting with automatic deploys from GitHub | Cost: ₦0 (Free) for personal, non-commercial projects\n• Google Jules — Best for: Agentic, autonomous bug fixes, tests, and small features | Cost: ₦0 (Free introductory tier), daily task allowance',
      },
    ],
    exercise:
